...
NTSTATUS captureBuffer(PVOID* ppDst, const void* pSrc, size_t nSrcSize)
{
	...
	PVOID pTempBuffer = ExAllocatePool2(POOL_FLAG_PAGED, nSrcSize, c_nAllocTag);
...
NTSTATUS captureUnicodeString(PCUNICODE_STRING* ppusDst, PCUNICODE_STRING pusSrc)
{
	...
	PUINT8 pBuffer = (PUINT8)ExAllocatePool2(POOL_FLAG_PAGED, nBufferSize, c_nAllocTag);
	...
	SysmonEvent eEvent)
{
	...
	auto pEventData = (EventData*)ExAllocatePool2(POOL_FLAG_PAGED,
