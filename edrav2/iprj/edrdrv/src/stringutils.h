...
inline NTSTATUS cloneUnicodeString(PCUNICODE_STRING pSrc, UNICODE_STRING* pDst, PVOID* ppBuffer)
{
	...
	PVOID pStrBuffer = ExAllocatePool2(POOL_FLAG_NON_PAGED, nStrBufferSize, c_nAllocTag);
...
public:
	...
	// Alloc empty string
	//
	NTSTATUS alloc(size_t nMaxSizeCb, POOL_FLAGS ePoolType = POOL_FLAG_NON_PAGED)
	//NTSTATUS alloc(size_t nMaxSizeCb, POOL_TYPE ePoolType = NonPagedPool)
	{
		...
		PVOID pStrBuffer = ExAllocatePool2(ePoolType, nMaxSizeCb, c_nAllocTag);
	...
	//
	//
	NTSTATUS assign(PCUNICODE_STRING pusSrc, POOL_FLAGS ePoolType = POOL_FLAG_NON_PAGED)
	{
	...
	//
	//
	NTSTATUS concatenate(PCUNICODE_STRING String1, PCUNICODE_STRING String2 = nullptr, PCUNICODE_STRING String3 = nullptr, PCUNICODE_STRING String4 = nullptr, POOL_FLAGS ePoolType = POOL_FLAG_NON_PAGED)
	{
