...
{
	auto pCtx = (Context*)ExAllocatePool2(POOL_FLAG_NON_PAGED,
...
NTSTATUS Context::init()
{
	...
	do 
	{
		...
		pOpenProcessFilter = new (PoolType::NonPaged) OpenProcessFilter;
		...
		pRegMonEventFilter = new (PoolType::NonPaged) RegMonEventFilter(
