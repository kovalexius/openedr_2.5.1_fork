...
{	
	...
	__try
	{
		...
		do 
		{
			...
			pVolumeProperties = (PFLT_VOLUME_PROPERTIES)ExAllocatePool2(POOL_FLAG_NON_PAGED, nBufferSize, c_nAllocTag);
...
NTSTATUS applyForEachInstance(TFn fn)
{
	...
	__try
	{
		...
		// Alloc buffer
		pInstances = (PFLT_INSTANCE*)ExAllocatePool2(POOL_FLAG_NON_PAGED,
